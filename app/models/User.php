...
class User extends Eloquent implements UserInterface, RemindableInterface {
    ...
    public static $rules = array('firstname' => 'required|min:2',
                                            'username' => 'required|unique:users',
                                            'email' => 'required|unique:users',
                                            'mobile' => 'required|unique:users'
                                            );

    public static $messages = array('firstname.min' =>'First Name field should be two characters atleast.',
                                            'username.unique' => 'Username already exists. Try another one.',
